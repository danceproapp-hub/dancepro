...
export const zh: Dictionary = {
  ...
  home: {
    ...
    ideaPara1:
      "打开 DancePro，按你真正需要的条件去找：你的舞种、你的水平、你所跳的角色，可以在自家舞蹈室附近，也可以在世界任何角落。返回的都是真实的舞者，每个人都已经写明自己跳什么、想找什么样的搭档。",
    ideaPara2:
      "你向合适的人发出连接请求。对方接受后，对话就在应用内开始。到了周末，你们已经定好了练习时间，并选好了要一起备战的比赛。",
    ideaPara3:
      "这就是 DancePro：符合你要求的舞者集中在一个地方，而且他们来这里的理由和你完全一样。",
