...
export const zh: Dictionary = {
  ...
  howItWorks: {
    ...
    s1Body:
      "建立一份专业的舞者档案：姓名、城市、你所跳的舞种、你的竞技水平，以及你想找什么样的搭档。写得具体一些。Leader、Follower 或两者皆可。从初学到 Professional。International Latin 或 Argentine Tango。档案越准确，你找到的舞者就越合适。",
    s2Body:
      "按舞种、角色、水平和所在地筛选浏览符合你要求的舞者——或者干脆让档案保持开放，让对的人来找到你。",
    s3Body:
      "直接而专业地联系对方。在回复之前，他们就能看到你跳什么、在找什么。连接始终是双向的。未经同意，没有人会进入你的人脉，也没有人能看到你的资料。",
    s4Body:
