...
export const es: Dictionary = {
  ...
  home: {
    ...
    ideaBody:
      "Di qué bailas, tu nivel y el rol que llevas, y mira quién busca exactamente eso: en tu academia, al otro lado del mundo o alguien que se mudaría a donde tú estés. Sin publicaciones en grupos, sin esperar a que un profesor pregunte por ahí. Alguien que entrena de la misma manera, quiere las mismas victorias y tiene libres las mismas noches. Para el fin de semana ya estáis en la pista juntos.",
