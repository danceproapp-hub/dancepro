...
export const ja: Dictionary = {
  ...
  howItWorks: {
    ...
    s1Body:
      "ダンサーとしてのプロフィールを整えます。名前、都市、踊る種目、競技レベル、そしてどんなパートナーシップを求めているか。具体的に。Leader、Follower、またはその両方。初級から Professional まで。International Latin や Argentine Tango など。プロフィールが正確なほど、見つかるダンサーの質も上がります。",
    s2Body:
      "種目・ロール・レベル・地域で絞り込んで探せます。あるいはプロフィールを公開したままにして、ふさわしい相手から見つけてもらうこともできます。",
    s3Body:
      "直接、そして礼儀正しく。相手は返事をする前に、あなたが何を踊り何を求めているかを確認できます。つながりは常に相互です。承認なしに誰かがあなたのネットワークに加わることも、あなたの情報を見ることもありません。",
    s4Body:
