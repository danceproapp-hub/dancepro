...
export const ja: Dictionary = {
  ...
  home: {
    ...
    ideaBody:
      "踊る種目、レベル、ロールを伝えれば、まさにそれを探している人が見つかります。同じスタジオにも、地球の裏側にも、あなたのいる場所へ引っ越す用意のある人にも。グループへの投稿も、コーチが探してくれるのを待つ必要もありません。同じように練習し、同じ競技会を目指し、同じ夜に時間がある相手。週末には、もう一緒にフロアに立っています。",
